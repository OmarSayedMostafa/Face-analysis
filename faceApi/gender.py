...
class GenderClssifier:
    def __init__(self, gender_model_path, labels_list):
        self.gender_model_path = gender_model_path
        self.labels_list = labels_list
        self.model = load_model(self.gender_model_path, compile=False)
    ...
    def predict(self, faces_batch):
        '''
        classfying human gender on given RGB Faces Batch
        '''
